...
set project_name "prj_compute_allff01"
set includepath  {../../lib}
set modules 	 {  
    ../../tb/Compute_allff.v
    ...
    ../../lib/alu/alu_serial_ff.v
    ../../lib/opmux/opmux_behav_ff.v
}
#set testbench 	 { ../tb/tb_bus_mux_vivado.v }
set  constrpath "../../tb/constraints-allff.xdc"
...
set_property top Compute_allff [current_fileset]
update_compile_order -fileset sources_1
